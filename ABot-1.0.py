...
parser.add_argument('--coms', type=list, default=[[6,8],[6,9],[8,9]])
...
parser.add_argument('--L2_reg', type=float, default=1e-3) #5e-3 bad
...
parser.add_argument('--ssa_schedule',type=str,default="sin",help="linear, cos, sin") # cos: slow->fast; sin: fast->slow #cos bad
...
for src_com,tgt_com in args.coms:
    ...
    # Tgt Dataset Split
    random_node_split = RandomNodeSplit(num_val=0,num_test=1-args.train_ratio)
